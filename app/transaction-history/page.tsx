...
import { ArrowRight, Sun, Moon, Download, Search, Filter, ChevronDown, ArrowUpRight, ArrowDownLeft } from 'lucide-react'
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <nav className="hidden md:flex space-x-4">
              ...
              <a href="/manage-events" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Manage Events</a>
              <a href="/transaction-history" className="text-sm font-medium text-primary">Transaction History</a>
            </nav>
          </div>
          <div className="flex items-center space-x-4">
