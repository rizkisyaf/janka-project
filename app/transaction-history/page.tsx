        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="/legal/janka-privacy-policy" className="hover:text-gray-300">Privacy Policy</a></li>
                <li><a href="/legal/janka-terms-of-service" className="hover:text-gray-300">Terms of Service</a></li>
                <li><a href="/legal/janka-cookie-policy" className="hover:text-gray-300">Cookie Policy</a></li>
                <li><a href="/legal/janka-compliance" className="hover:text-gray-300">Compliance</a></li>
              </ul>
            </div>
            <div>
