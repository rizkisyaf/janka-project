          ...
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="/explore-market" className="hover:text-gray-300">Explore Markets</a></li>
                ...
                <li><a href="/user-dashboard" className="hover:text-gray-300">User Dashboard</a></li>
                <li><a href="/manage-events" className="hover:text-gray-300">Manage Events</a></li>
                <li><a href="/transaction-history" className="hover:text-gray-300">Transaction History</a></li>
                <li><a href="/custom-event-request" className="hover:text-gray-300">Custom Event Request</a></li>
                <li><a href="/legal" className="hover:text-gray-300">Legal</a></li>
              </ul>
            </div>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <form className="mt-2 flex">
                  <input type="email" placeholder="Enter your email" className="px-3 py-2 bg-gray-700 text-white rounded-l-md focus:outline-none focus:ring-2 focus:ring-primary" />
