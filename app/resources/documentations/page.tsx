                ...
                <div className="container mx-auto px-4 py-4 flex items-center justify-between">
                    <div className="flex items-center space-x-4">
                        ...
                        <nav className="hidden md:flex space-x-4">
                            ...
                            <a href="/community-forum" className="text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">Community</a>
                        </nav>
                    </div>
                    <div className="flex items-center space-x-4">
                    ...
                    <div className="grid md:grid-cols-4 gap-8">
                        <div>
                            ...
                            <ul className="space-y-2">
                                ...
                                <li><a href="/about/janka-team" className="hover:text-gray-300">Team</a></li>
